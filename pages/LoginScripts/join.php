...
$mysessionID = mysqli_real_escape_string($db,$_POST['sessionID']);

/*
$sql = "INSERT INTO registration (email, firstName, lastName, password, username)
VALUES ('$myemail', '$myfirstname', '$mylastname', '$mypassword', '$myusername')";
*/
